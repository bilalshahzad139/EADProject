    ...
    public static class ProductDAO
    {
        public static int Save(ProductDTO dto)
        {
            using (var helper = new DBHelper())
            {
                ...
                {
                    sqlQuery = String.Format("INSERT INTO dbo.Products(Name, Price,CreatedOn, CreatedBy,IsActive,ProductCategoryID) VALUES('{0}','{1}','{2}','{3}','{4}',{5}); Select @@IDENTITY",
                        dto.Name, dto.Price, dto.CreatedOn, dto.CreatedBy, 1,dto.CategoryID);
